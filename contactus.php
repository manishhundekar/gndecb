...
<div class="head gnddepthead"><h3 class="font-weight-bold " style="color: #3375F1;">Contact Us</h3></div><hr>
        <div class="container">
           <!-- contact -->
  <section class="party-plane-row party--temp-contact py-5" id="contact">
    <div class="container py-xl-5 py-lg-3">
      ...
      <div class="row contact-form py-3">
        <div class="col-lg-6 party-plane-form-left">
          <!-- contact form grid -->
          <div class="contact-top1">
            <form action="contactconnect.php" method="POST" class="f-color">
        ...
        <div class="col-lg-6 map mt-lg-0 mt-5">
          <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d5369.328955827059!2d77.51470615294458!3d17.900001303887812!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xbe5504c72b86fb2b!2sGuru+Nanak+Dev+Engineering+College+Bidar!5e0!3m2!1sen!2sin!4v1560073062620!5m2!1sen!2sin"
              allowfullscreen></iframe>
              <br>
              <b> Contact us :+91  +91 9741892834 <br> mail to : principal@gndecb.ac.in<br>
                principalgndecb@gmail.com</b>
        </div> 
