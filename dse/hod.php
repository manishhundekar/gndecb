...
<div class="head gnddepthead"><h3 class="font-weight-bold">Department of Computer Science and Engineering</h3></div><hr>
  ...
  <div class="container">
      ...
      <div class="row no-gutters">
        ...
        <div class="col-xl-12 ">
         <center> <img class="img-fluid rounded" src="docs/hodcse.jpg">
          <h5><strong><span style="color: #800080;"><em>Dr. Manohar Madgi</em></span></strong></h5>
          <h6 class="text-colors let-spa">Professor & Head</h6><br></center>
         <br>
          <p>Our aim is to develop the CSE department into a center of excellence imparting quality education, in the field of computer science and engineering. The department emphasizes human values and ethics. We lay stress on overall development of the students to meet the requirement of the IT industry.</p> 
        </div>
      </div>
      </div><hr>
