...
<div class="head gnddepthead"><h3 class="font-weight-bold">Training & Placement Cell</h3></div><hr>
  ...
  <div class="container">
        ...
        <div class="row">
          ...
          <div class="alert alert-danger" role="alert"><center><b>Training and Placement Officer Desk</b> </div>
            
      <div class="row no-gutters">
       
        <div class="col-xl-12 ">
         <center> <img class="img-fluid rounded" src="images/tp.jpg">
          <h4><strong><span style="color: #800080;"><em>Prof.Shravan Kumar</em></span></strong></h4>
          <h6 class="text-colors let-spa" style="color: #800080;">Training and Placement Officer</h6>
           <h6 class="text-colors let-spa">Contact:+91 6364925581  &nbsp & +91 9900418224  </h6>

           <h6 class="text-colors let-spa">Mail:placement@gndecb.ac.in</h6></center>
         <br>
         <p> Training and Placement Cell in the Institute plays a vital role and is becoming a key department of the Institute. It is the backbone of any institute. Employment of the students of the Institute will be our major concern.</p>
 
<p>A well organized placement cell will be functioning in the Institution with a fulltime dedicated Placement Officer, who continuously monitors the employment potentials and arranges the campus, interviews for the students.</p>
 
<p>The Placement Officer will maintain a consistent communication with the companies for placement of the students. The Placement Cell will provide the infra-structural facilities to conduct group discussions, tests and interviews.</p>
 
<p>The Placement Office serves to merely bridge the gap between a job-aspirant and a prospective employer.</p>
        </div>
      </div>
      </div><hr>
