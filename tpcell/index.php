...
<div class="head gnddepthead"><h3 class="font-weight-bold">Training & Placement Cell</h3></div><hr>
  ...
  <div class="container">
        ...
        <div class="row">
           ...
           <div class="alert alert-primary" role="alert"><center> <b>About T & P Cell</b></center></div>
          
        <p>  The Training & Placement Department is an indispensable pillar of the Institute. It has an important role to play in the student's prospects for employability. Placements provide an opportunity for students to demonstrate, in the real world, the application of the knowledge they have acquired over the years.</p>

<p>This department continuously strives to help students acquire employment relevant skills so that they can pursue their career goals with challenging roles in the industry.</p>

<p>We recognize the power and strength of our educational methods and the impact this has in providing suitable placement for students in the industry. Our department is a place where our prospective engineers create and develop skills relevant to the responsibilities they will should in the work place. We trust "To reap the benefits tomorrow, we need to sow the seeds today" and we act upon it.</p>

<p>We earnestly work to transform the talent pool through training programs by experts from the industry. The department is proactive and has a team of experienced resources who groom and nurture students.The department engages with the industry. Organizations invited for campus recruitments so that students get career offers before they graduate from the college.</p>
           <hr>
