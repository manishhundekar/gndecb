...
?>
<?php 
      $order59 ="SELECT * FROM events where EVTTYP='SOCIAL' order by DATE DESC";
      $food9 = mysqli_query($conn, $order59);

?>
<!DOCTYPE html>
<head>
	<title>SOCIAL EVENTS| GNDECB</title>
	<meta charset="UTF-8" />
...
<div id="header"></div>
	<section class="blog " id="blog">
		<div class="container">
			<h2 class="text-bl text-center font-weight-bold mb-2">SOCIAL EVENTS</h2>
			<div class="row">
