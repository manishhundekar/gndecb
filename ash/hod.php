...
<div class="head gnddepthead"><h3 class="font-weight-bold">Department of Applied Sciences and Humanities</h3></div><hr>
  ...
  <div class="container">
      ...
      <div class="row no-gutters">
        ...
        <div class="col-xl-12 ">
         <center> <img class="img-fluid rounded" src="docs/hodphysics.jpeg">
          <h5><strong><span style="color: #800080;"><em>Dr.Sindhu S</em></span></strong></h5>
          <h6 class="text-colors let-spa">Professor & HoD</h6><br></center>
         <br>
          <p><b>“The Science of Today is the Technology of the Tomorrow”</b></p>

<p>Welcome to the Department of Applied Sciences and Humanities. The department is established with the aim of enriching forth coming engineers with profound academic base. The ever flowing zeal of excellence, adaptability and flexibility are the key success factors of the department. The department has an excellent team of dedicated, well qualified and experienced teaching and supporting staff. Our main objective is to inspire and enable the students to handle the complex challenges that lie at the interfaces of science, technology and society. Thank you for visiting us.
Best Wishes to all Students</p> 
        </div>
      </div>
      </div><hr>
