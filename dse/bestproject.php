...
<html lang="zxx">
   ...
   <body>
      ...
      <div class="head gnddepthead">
         <h3 class="font-weight-bold">Department of Computer Science & Engineering</h3>
      </div>
      <hr>
      <div class="container">
         <!-- Content Row -->
         <div class="row">
            ...
            <div class="col-md-8" style="text-align:justify;">
               <div class="alert alert-primary" role="alert">
                  <center><b>BEST PROJECT</b></center>
               </div>
               <p><span style="color: #993366;"><strong>2019-2020</strong></span></p>
               <table border="1">
                  <tbody>
                     <tr>
                        <td style="text-align: center;" width="56">
                           <p><span style="color: #800000;"><strong>Sl.No.</strong></span></p>
                        </td>
                        <td style="text-align: center;" width="92">
                           <p><span style="color: #800000;"><strong>USN</strong></span></p>
                        </td>
                        <td style="text-align: center;" width="91">
                           <p><span style="color: #800000;"><strong>Name of the students</strong></span></p>
                        </td>
                        <td style="text-align: center;" width="90">
                           <p><span style="color: #800000;"><strong>Area</strong></span></p>
                        </td>
                        <td style="text-align: center;" width="91">
                           <p><span style="color: #800000;"><strong>Relevance</strong></span></p>
                        </td>
                        <td style="text-align: center;" width="91">
                           <p><span style="color: #800000;"><strong>Guide</strong></span></p>
                        </td>
                        <td style="text-align: center;" width="127">
                           <p><span style="color: #800000;"><strong>Title of the Project</strong></span></p>
                        </td>
                     </tr>
                     <tr>
                        ...
                        <td rowspan="4" width="91">
                           <p>Prof Manik Rao Mulge</p>
                        </td>
                        <td rowspan="4" width="127">
                           <p>IOT/Agricultural crop recommendation system using IoT with ML</p>
                        </td>
                     </tr>
                     <tr>
                        <td width="92">
               ...
               <p>&nbsp;</p>
               <p><span style="color: #993366;"><strong>2018-2019</strong></span></p>
               <table border="1">
                  <tbody>
                     <tr>
                        <td style="text-align: center;" width="56">
                     ...
                     <tr>
                        ...
                        <td rowspan="4" width="127">
                           <p>2 Layer authentication employing location for secured &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
               ...
               <p>&nbsp;</p>
               <p><span style="color: #993366;"><strong>2017-2018</strong></span></p>
               <table border="1">
                  <tbody>
                     <tr>
                        <td width="56">
                           <p style="text-align: center;"><span style="color: #800000;"><strong>Sl.No.</strong></span></p>
                        </td>
                        <td style="text-align: center;" width="92">
                           <p><span style="color: #800000;"><strong>USN</strong></span></p>
                        </td>
                        ...
                        <td width="127">
                           <p style="text-align: center;"><span style="color: #800000;"><strong>Title of the Project</strong></span></p>
                        </td>
                     </tr>
                     <tr>
                        ...
                        <td width="127">
                           <p>Smart Garbage Monitoring using IOT</p>
                        </td>
                     </tr>
                  </tbody>
               </table>
