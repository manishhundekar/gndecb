...
<div class="head gnddepthead"><h3 class="font-weight-bold">Department of Civil Engineering</h3></div><hr>
  ...
  <div class="container">
      ...
      <div class="row no-gutters">
        ...
        <div class="col-xl-12 ">
         <center> <img class="img-fluid rounded" src="docs/civilhod.jpg">
          <h5><strong><span style="color: #800080;"><em>Dr. B. B. KORI</em></span></strong></h5>
          <h6 class="text-colors let-spa">Professor & HoD</h6><br></center>
         <br>
          <p>You are welcome to the Department of Civil Engineering which has a team of highly experienced and motivated faculty members who are in the process of tuning the young minds to make them globally competitive. Innovative methods of teaching and learning process are adopted to achieve learning abilities through practice, exposure and motivation.</p> 
        </div>
      </div>
      </div><hr>
