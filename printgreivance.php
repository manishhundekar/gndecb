...
<?php
  ...
  if (isset($_POST['print'])) {
      $email = $_POST['email'];
      $order59 ="SELECT * FROM grievance where adslno='$email' ";
...
<div class="container">
  <table>
    ...
    <tbody>
        <tr><td colspan="6" class="font-weight-bold"><h3>GRIEVANCE FORM</h3></td></tr>
        <tr>
            <td><label class="font-weight-bold ">GRIEVANCE ID</label></td>
            <td colspan="5"><br><?php echo $oss55["ADSLNO"];?><br></td>
        </tr>

        <tr><td class="font-weight-bold ">Grievant Type:</td><td><?php echo $oss55["GRIEVTYPE"];?></td><td class="font-weight-bold ">User Type:</td><td><?php echo $oss55["USERTYPE"];?></td><td class="font-weight-bold ">Time of Submission:</td><td><?php echo $oss55["TIME"];?></td></tr>
        <tr>
            <td><label class="font-weight-bold ">Description</label></td>
            <td colspan="5"><br><?php echo $oss55["DESCRIPTION"];?><br></td>
        </tr>
        <tr>
            <td><label class="font-weight-bold ">Applicant's Name</label></td>
            <td><?php echo $oss55["NAME"];?></td>
        ...
        <tr>
            ...
            <td colspan="5"><?php echo $oss55["ADD1"];?>,<br><?php echo $oss55["CITY"];?>,<?php echo $oss55["PINCODE"];?>,<?php echo $oss55["STATE"];?>,<?php echo $oss55["COUNTRY"];?></td>
        </tr>
         <tr>
            <td><label class="font-weight-bold ">EMAIL ID</label></td>
            <td colspan="5"><br><?php echo $oss55["EMAIL"];?><br></td>
        </tr>
