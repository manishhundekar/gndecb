...
<div class="head gnddepthead"><h3 class="font-weight-bold">Training & Placement Cell</h3></div><hr>
  ...
  <div class="container">
        ...
        <div class="row">
           ...
           <div class="alert alert-primary" role="alert"><center> <b>Our Placements</b></center></div>
...
<div class="container">
   <div class="row">
    ...
    <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/d1.jpeg" class="card-img-top" alt="...">
    ...
    <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/d2.jpeg" class="card-img-top" alt="...">
        
      </div>
    </div>
     <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/d3.jpeg" class="card-img-top" alt="...">
        
      </div>
    </div>
     <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/d4.jpg" class="card-img-top" alt="...">
   ...
   <div class="row">
    ...
    <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/d5.jpg" class="card-img-top" alt="...">
    ...
    <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/d6.jpg" class="card-img-top" alt="...">
        
      </div>
    </div>
     <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/d8.jpg" class="card-img-top" alt="...">
        
      </div>
    </div>
     <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/d9.jpg" class="card-img-top" alt="...">
  ...
  <div class="row">
    ...
    <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/p13.jpeg" class="card-img-top" alt="...">
    ...
    <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/p11.jpeg" class="card-img-top" alt="...">
        
      </div>
    </div>
     <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/p12.jpeg" class="card-img-top" alt="...">
        
      </div>
    </div>
    <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/p16.jpeg" class="card-img-top" alt="...">
  ...
  <div class="row">
    ...
    <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/d10.jpg" class="card-img-top" alt="...">
        
      </div>
    </div>
     <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/d11.jpg" class="card-img-top" alt="...">
        
      </div>
    </div>
     <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/p17.jpeg" class="card-img-top" alt="...">
        
      </div>
    </div>
    <div class="col-xl-3 col-md-3 mb-2">
      <div class="card border-0 shadow">
        <img src="placement/p15.jpeg" class="card-img-top" alt="...">
