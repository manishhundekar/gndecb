...
<div class="container" style="background-color: white">
    <ol class="breadcrumb">
        ...
        <li>College Committees</li>
    </ol>
</div>
<div class="head gnddepthead"><h2 class="font-weight-bold " style="color: #3375F1;">Academic Details</h2></div><hr>
<body>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>01</td>
                                                    <td>2021 Scheme</td>
                                                    <td><a href="docs/vtu/be2021.pdf" target="_blank"> <button type="button" class="btn btn-primary btn-sm btn-block">Click here</button></a></td>
                                                    
                                              </tr>
                                              <tr>
                                                <td>02</td>
                                                <td>2018 Scheme</td>
                                               <td><a href="docs/vtu/be201819.pdf" target="_blank"> <button type="button" class="btn btn-primary btn-sm btn-block">Click here</button></a></td>
                                              
                                              </tr>
												                    <tr>
                                                  <td>03</td>
                                                  <td>2017 Scheme	</td>
                                                  <td><a href="docs/vtu/becbcs2017-18.pdf" target="_blank"> <button type="button" class="btn btn-primary btn-sm btn-block">Click here</button></a></td>
                                              </td>
                                                  </tr>
											                        <tr>
                                                <td>04</td>
                                                <td>	2015	Scheme</td>
                                                <td><a href="docs/vtu/becbcs2015-16.pdf" target="_blank"> <button type="button" class="btn btn-primary btn-sm btn-block">Click here</button></a></td>
                                              </td>
