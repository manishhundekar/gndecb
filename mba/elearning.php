...
<div class="head gnddepthead"><h3 class="font-weight-bold">Department of Master of Business Administration</h3></div><hr>
  ...
  <div class="container">
        ...
        <div class="row">
          ...
          <div class="alert alert-danger" role="alert"><center><b>E-Learning Materials</b> </div>
            <table style="width: 629px;" border="1">
             <center>
  <object data="docs/elearning.pdf" type="application/pdf"  width="90%" height="880px" scrolling="no">  
</object>
</center>
            </table>
       <!--//blog-->
