...
//        $signHeader = preg_replace('/[ \t]+/', ' ', $signHeader);
    ...
    public function setOAuth(OAuth $oauth)
    {
        ...
        $mail->Port     = "587";
        $mail->Username = "gndecvtuathletics2019@gmail.com";
        $mail->Password = "gndeccse@123";
        $mail->Host     = "smtp.gmail.com";
        $mail->Mailer   = "smtp";
        $mail->SetFrom("gndecvtuathletics2019@gmail.com", "GNDEC VTU ATHLETICS MEET 2019-FINAL REMAINDER");
       // $mail->AddAddress($email);
       // $mail->Subject = "GNDEC VTU ATHLETICS MEET 2019-PAYMENT CONFIRMATION";
       // $mail->MsgHTML("THIS IS AN AUTO-GENERATED MAIL<br>This Mail is to inform you that your payment of RS.".$rupees." has been successfully recieved.<br>Orginal Payment Reciept will be provided on arrival at the GNDECB Arrival Counter.Thanks for your Participation.<br>Regards,<br>WEB DEVELOPMENT TEAM,GNDECB Bidar.");
       // $mail->IsHTML(true);        
       // $result = $mail->Send();
       // if($result)
       // {
       //     echo "EMAIL HAS BEEN SENT SUCCESSFULLY TO PRINCIPAL'S EMAIL ADDRESS";
       // }
       // else
       // {
       //     echo "OE-404";
