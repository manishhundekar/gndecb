...
<div class="head gnddepthead"><h3 class="font-weight-bold">Deparment of Electronics and Communication Engineering</h3></div><hr>
  ...
  <div class="container">
        ...
        <div class="row">
         ...
         <div class="alert alert-primary" role="alert"><center><b> Infrastructure Details </b></center> </div>
          
          <table style="width: 629px;" border="1">
             <center>
  <object data="docs/infrastructure.pdf" type="application/pdf"  width="90%" height="880px" scrolling="no">  
</object>
</center>
            </table>
               <hr>
